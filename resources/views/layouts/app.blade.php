    ...
    <body>
            ...
            <div class="container">
                <div class="nav-wrapper">
                    ...
                    <a class="navbar-brand" href="{{ route('shop.index') }}">
                        <img src="{{ asset('images/WhatsApp Image 2024-12-30 at 17.17.10_9f069848.jpg') }}" alt="تِــريَــاق" style="width: 150px; height:100px;">
                    </a>
        ...
        <footer class="footer mt-5 py-4" style="background-color: white !important; color: black !important;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h5 style="color: black;">AGIESEGY STORE</h5>
                    ...
                    <div class="col-md-4">
                        ...
                        <p style="color: black;"><i class="fas fa-envelope me-2"></i>tele</p>
                        <p style="color: black;"><i class="fas fa-phone me-2"></i>01055705319</p>
                    </div>
                </div>
                <hr style="background-color: black;">
                <div class="text-center">
                    <p style="color: black;">&copy; 2025 agiesegy Store. All rights reserved.</p>
                </div>
            </div>
        </footer>

        <!-- WhatsApp Floating Icon -->
        <a href="https://wa.me/201055705319" class="whatsapp-float" target="_blank">
