  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('images\IMG-20241230-WA0030.jpg') }}" class="bd-placeholder-img w-100" style="object-fit: cover; height: 100vh;" alt="Slide 1">
            <div class="container">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/IMG-20241230-WA0031.jpg') }}" class="bd-placeholder-img w-100" style="object-fit: cover; height: 100vh;" alt="Slide 2">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/IMG-20241230-WA0032.jpg') }}" class="bd-placeholder-img w-100" style="object-fit: cover; height: 100vh;" alt="Slide 3">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/IMG-20241230-WA0033.jpg') }}" class="bd-placeholder-img w-100" style="object-fit: cover; height: 100vh;" alt="Slide 4">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/IMG-20241230-WA0034.jpg') }}" class="bd-placeholder-img w-100" style="object-fit: cover; height: 100vh;" alt="Slide 5">
            <div class="container">
                <div class="carousel-caption">
